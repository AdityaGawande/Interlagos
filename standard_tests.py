...
def cmrr_measurement_single(Gain_ideal, dmm1, dmm2, dmm3, iterator):
    ...
    print(xy_diff, ',' , V22-V21, ',' , V21, ',' , V22, ',' , VO2-VO1, ',' , VO1, ',' , VO2, ',' , VCM2-VCM1, ',' , VCM1, ',' , VCM2, ',' , str(datetime.now()), ',' , iterator)
...
def cmrr_measurement(n, Gain_ideal, PLC):
    ...
    print("XY_DIFF, VDIFF, VDIFF1, VDIFF2, VOUT, VOUT1, VOUT2, VCM, VCM1, VCM2, time, reading_number")
    for i in range(0, n):
