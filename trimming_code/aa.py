...
smu = rm.open_resource('USB0::0x05E6::0x2636::4428135::INSTR')  # Replace with your actual VISA address
...
# Configure Channel A (source current, limit voltage)
...
smu.write("smua.source.output = smub.OUTPUT_ON")       # Enable output
