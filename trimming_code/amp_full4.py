...
cm_v = [0.5, 0.5]
isense_v = [0.0015, 0.002]
isense_vcm=[0.008,0.008]
        ...
        if k == 0:
           ...
           # turn_off_smu_output()
            ...
            for i in range(2):
                ...
                r1[i] = float(results[0])
                r2[i] = float(results[1])
                r3[i] = float(results[2])
                # dmm1 - output
                # dmm2 - vsense
                # dmm3 - common mode
            ...
            gain = (r1[1] - r1[0])/(r2[1] - r2[0])
            # gain_array = []
            accumulated_gain = accumulated_gain + gain
            print(accumulated_gain/(j+1))
