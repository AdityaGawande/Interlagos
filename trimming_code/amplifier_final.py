...
while j < 7:
    ...
    #     value2 = gsheet_util_new.read_single_value(google_sheet_id, google_sheetname2, "C62")
    #     trim_bit1 = value1
    #     trim_bit2 = value2
    #     cell_value_pairs = [
    #    ("B12", value1),
    ...
    if j==5:
        ...
        value2 = gsheet_util_new.read_single_value(google_sheet_id, google_sheetname2, "C75")
        trim_bit1 = value1
        trim_bit2 = value2
        cell_value_pairs = [
       ("B12", value1),
           ...
           # turn_off_smu_output()
            ...
            if j==3:
                ...
                for i in range(2):
                    ...
                    gsheet_util_new.write_multiple_values(google_sheet_id, google_sheetname2,cell_value_pairs)
                    value1 = float(gsheet_util_new.read_single_value(google_sheet_id, google_sheetname2, "C58"))
                    if value1>0:
                        trim_bit1 = 1
                        trim_bit2 = 0
                        #print(f"Trim bits from B8: {trim_bit}")
