# Copied from amp_full_gainxy_compute_3.py
...
cm_v = [0.5,8,8]
isense_v = [-0.01, -0.01, 0.01]
isense_vcm=[0.008,0.009,0.008]

average_window = 1

# Take addresses from constants.py
...
# Better version of measure_dmm exists
...
while j < 1:
    ...
    if j==1:
       ...
       ("B9", 1),
        ...
        gsheet_util_new.write_multiple_values(google_sheet_id, google_sheetname1,cell_value_pairs)
    if j==2:
        value1 = gsheet_util_new.read_single_value(google_sheet_id, google_sheetname2, "C36")
        value2 = gsheet_util_new.read_single_value(google_sheet_id, google_sheetname2, "F36")
        trim_bit1 = value1
        trim_bit2 = value2
        cell_value_pairs = [
       ("B8", value1),
       ("B9", value2),
        ...
        #gsheet_util_new.write_multiple_values(google_sheet_id, google_sheetname1,cell_value_pairs)
    if j==3:
        value1 = gsheet_util_new.read_single_value(google_sheet_id, google_sheetname2, "C50")
        value2 = gsheet_util_new.read_single_value(google_sheet_id, google_sheetname2, "F50")
        trim_bit1 = value1
        trim_bit2 = value2
        #print(f"Trim bits from B8: {trim_bit}")
        cell_value_pairs = [
       ...
       ("B11", value2),
        ...
        gsheet_util_new.write_multiple_values(google_sheet_id, google_sheetname1, cell_value_pairs)
    if j==4:
        value1 = gsheet_util_new.read_single_value(google_sheet_id, google_sheetname2, "C64")
        value2 = gsheet_util_new.read_single_value(google_sheet_id, google_sheetname2, "F64")
        trim_bit1 = value1
        trim_bit2 = value2
        cell_value_pairs = [
       ("B12", value1),
       ("B13", value2),
        ...
        gsheet_util_new.write_multiple_values(google_sheet_id, google_sheetname1,cell_value_pairs)
    if j==5:
        value1 = gsheet_util_new.read_single_value(google_sheet_id, google_sheetname2, "C77")
        value2 = gsheet_util_new.read_single_value(google_sheet_id, google_sheetname2, "F77")
        trim_bit1 = value1
        trim_bit2 = value2
        cell_value_pairs = [
       ("B14", value1),
        ...
        # Take 3 measurements and put them into 'proposed method' google sheet
            ...
            for l in range(1):
               ...
               for i in range(3):
                    ...
                    # time.sleep(1)
                    smu_vcm.write(":SOUR:VOLT:ILIMIT 0.02")
                    time.sleep(1)
                    #smu_vcm.write(f":SOUR:VOLT {cm_voltage}")
